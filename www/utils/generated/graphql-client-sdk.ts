...
columns and relationships of "address" */
  ...
  ["mutation_root"]: AliasType<{
    ...
    delete_order_status?: [
      ...
      ValueTypes["order_status_mutation_response"]
    ];
    delete_order_status_by_pk?: [
      { status: string },
      ValueTypes["order_status"]
    ];
    delete_product?: [
      {
        /** filter the rows which have to be deleted */
    ...
    update_order_status_by_pk?: [
      {
        /** sets the columns of the filtered rows to the given values */
        _set?: ValueTypes["order_status_set_input"];
        pk_columns: ValueTypes["order_status_pk_columns_input"];
      },
      ValueTypes["order_status"]
    ];
    update_product?: [
...
columns and relationships of "order_product" */
  ...
  ["order_status_aggregate_fields"]: AliasType<{
    count?: [
      {
        columns?: ValueTypes["order_status_select_column"][];
        distinct?: boolean;
      },
      true
    ];
...
columns and relationships of "product_review" */
  ...
  ["query_root"]: AliasType<{
    ...
    order_status_aggregate?: [
      ...
      ValueTypes["order_status_aggregate"]
    ];
